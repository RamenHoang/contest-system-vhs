    ...
    >
      <Card className='w-96 p-4 shadow-md'>
        <div className='flex-center flex-col gap-2 mb-10'>
          <img alt='nextui logo' src='/logo.png' width={100} />
          <h4 className='font-bold text-2xl'>VHS</h4>
        ...
        >
          ...
          >
            <Input prefix={<User2Icon className='h-4 w-4 text-gray-500' />} size='large' />
          </Form.Item>
          <Form.Item
            label='Mật khẩu'
            name='password'
          ...
          <Button size='large' htmlType='submit' type='primary' className='w-full'>
            Đăng nhập Admin
          </Button>
        </Form>

        {/* <Divider plain>
          <Typography.Text className='!text-xs !text-gray-400'>Hoặc</Typography.Text>
        </Divider>
        <Button
          size='large'
